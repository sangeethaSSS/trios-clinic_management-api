        ...
        if (req.jwtToken) {
            ...
            if (decoded) {
                ...
                (select a.tentative_time,a.token_number,a.appointment_status_id,a.patient_id,
                 ...
                 a.paymentstatus_id,b.consultation_id,a.fees AS fees,b.doctor_notes,
